			...
			<ul class="navbar-nav mr-auto">
				<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<a class="dropdown-item" href="<c:url value="/carro/listar"/>">Listar os Carros</a>
					</div>
			</ul>
			<form action="<c:url value="/carro/pesquisar"/>" method="get"
				class="form-inline my-2 my-lg-0">
				<input name="nome" class="form-control mr-sm-2" type="search"
					placeholder="Pesquisar Carros" aria-label="Search">
