	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
	  ...
	  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	    ...
	    <c:url value="/venda/pesquisar" var="acao"/>
	     <form class="form-inline my-2 my-lg-0" action="${acao}" method="get">
		      <input class="form-control mr-sm-2" type="search" placeholder="Cliente" aria-label="Search" name="pesquisa">
